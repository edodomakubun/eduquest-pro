...
import { BookOpen, Sparkles, Clock, ShieldCheck, Loader2, AlertCircle, Wand2, Mail, Lock, Eye, EyeOff, ArrowRight, Globe, Facebook, Settings } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row font-sans relative overflow-hidden bg-slate-900 lg:bg-white">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-900 p-12 flex-col justify-between overflow-hidden shadow-2xl z-10">
         ...
         <div className="relative z-10 flex items-center text-blue-200/60 text-sm font-medium">
           <ShieldCheck className="w-4 h-4 mr-2" /> Sistem Keamanan Terenkripsi © {new Date().getFullYear()}
         </div>
      </div>
      ...
      <div className="w-full lg:w-[55%] xl:w-1/2 flex flex-col items-center justify-center p-4 sm:p-8 relative z-10 min-h-screen lg:min-h-0">
        ...
        <div className="mt-12 text-center animate-in fade-in slide-in-from-bottom-12 relative z-10">
          ...
          <div className="flex items-center justify-center space-x-6 sm:space-x-8">
            <a href="https://ed-developing.pages.dev" target="_blank" rel="noopener noreferrer" className="flex items-center text-sm font-bold text-slate-300 lg:text-slate-500 hover:text-blue-400 lg:hover:text-blue-600 transition-colors group">
              <Globe className="w-4 h-4 mr-2 text-slate-400 lg:text-slate-400 group-hover:text-blue-400 lg:group-hover:text-blue-600 transition-colors" /> Portofolio
            </a>
